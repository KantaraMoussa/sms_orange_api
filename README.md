...
- **Contacts/Groupes** : gestion des contacts (CRUD, import CSV/Excel avec rapport détaillé), groupes avec appartenance, envoi d'une campagne à tout un groupe.
- **Modèles SMS** : bibliothèque réutilisable (créer/modifier/dupliquer/archiver, catégories marketing/transactionnel/notification/rappel/alerte).
- **Campagnes** : création, import de destinataires (fichier Excel : nom, prénom, téléphone, message), lancement en file d'attente par lots, suivi de progression en temps réel, pause/reprise/annulation, réessai des échecs.
