                    ...
                    <table id="groupesTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?= route('campaigns.show', ['id' => $c['id']]) ?>" class="btn btn-primary"> <i class="fa fa-eye"></i> Voir plus </a></td>
                            </tr>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content shadow-md">
            ...
            <div class="modal-body">
                <form action="<?= route('sms.sendSingle') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
