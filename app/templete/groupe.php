                    ...
                    <table id="groupesTable" class="table table-striped table-bordered">
                        ...
                        <?php else: foreach ($groups as $g): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=detail-groupe&id=<?= (int) $g['id'] ?>" class="btn btn-sm btn-primary"><i class="ph ph-eye"></i> Voir</a>
                                    <form action="../server/app.php" method="post" class="d-inline" onsubmit="return confirm('Supprimer ce groupe ? Les contacts eux-mêmes ne seront pas supprimés.');">
                                        <?= csrf_field() ?>
