                        ...
                        <tbody>
                            ...
                            <?php else: foreach ($allContacts as $c): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="../server/app.php" method="post" class="d-inline" onsubmit="return confirm('Supprimer ce contact ?');">
                                            <?= csrf_field() ?>
                        ...
                        <?php foreach ($importHistory as $imp): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../server/contacts_export_errors.php?import_id=<?= (int) $imp['id'] ?>" class="btn btn-sm btn-outline-secondary">Télécharger les erreurs</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
